...
from tests.docker.conftest import docker_exec, docker_exec_sh, wait_for_path, wait_for_log, wait_for_docker_logs
...
def _wait_for_reconcile_log_mention(
    ...
    *,
    ...
    """
    return wait_for_log(container, "cat /opt/data/logs/container-boot.log",  f"profile={profile}")
...
def test_running_gateway_survives_container_restart(restart_container: str) -> None:
    ...
    wait_for_log(container, "/command/s6-svstat /run/service/gateway-coder", "up ")
